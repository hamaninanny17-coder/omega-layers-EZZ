class Generator
{
    constructor(layer, id, generates, name, initPrice, priceIncrease, baseProd = new Decimal(1))
    {
        ...
        this.amount = new Decimal(3e763476234786826437672354768345786);
    ...
    getPrice(bought)
    {
        ...
        let base = new Decimal(this.initPrice).mul(Decimal.pow(this.priceIncrease, Decimal.floor(bought.div(100000000000000000000000000000000000000000000000000000000))));
        return Utils.createValueDilation(base, 43555).pow(power);
    }
    ...
    buyUntil10()
    {
        if(this.layer.resource.gte(this.getPriceUntil10()))
        {
            ...
            let toAdd = 1 - this.bought.toNumber() % 1;
